...
CREATE TABLE IF NOT EXISTS major(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `college_id` INT NOT NULL COMMENT '學校id',
...
CREATE TABLE IF NOT EXISTS major_course(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `major_id` INT NOT NULL COMMENT '學院id',
...
CREATE TABLE IF NOT EXISTS course(
    ...
    `head_id` INT NOT NULL COMMENT '主任id',
    `status` TINYINT(1) DEFAULT 1 COMMENT '0 停用 / 1 正常',
    `creator` VARCHAR(45) NOT NULL COMMENT '創建人員',
    `create_time` DATETIME NOT NULL COMMENT '創建時間',
    `update_time` DATETIME NOT NULL COMMENT '更新時間',
...
CREATE TABLE IF NOT EXISTS pre_course(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `course_id` INT NOT NULL COMMENT '課程id',
    `pre_course_id` INT NOT NULL COMMENT '先修課程id',
    `status` TINYINT(1) DEFAULT 1 COMMENT '0 停用 / 1 正常',
    `creator` VARCHAR(45) NOT NULL COMMENT '創建人員',
    `create_time` DATETIME NOT NULL COMMENT '創建時間',
    `update_time` DATETIME NOT NULL COMMENT '更新時間',
...
CREATE TABLE IF NOT EXISTS class(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `course_id` INT NOT NULL COMMENT '課程id',
    `teacher_id` INT NOT NULL COMMENT '老師id',
...
CREATE TABLE IF NOT EXISTS semester_class(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `semaster_id` INT NOT NULL COMMENT '學期id',
...
CREATE TABLE IF NOT EXISTS assesment(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `semester_id` INT NOT NULL COMMENT '學期id',
...
CREATE TABLE IF NOT EXISTS attendance(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `semester_class_id` INT NOT NULL COMMENT '學期班級id',
    `student_id` INT NOT NULL COMMENT '學生id',
...
CREATE TABLE IF NOT EXISTS student_homework(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主鍵',
    `homework_id` INT NOT NULL COMMENT '作業id',
    `student_id` INT NOT NULL COMMENT '學生id',
