...
public class RedisConstant {
    ...
    public static final String STUDENT_LOGIN_ID = "SMS:STUDENT:LOGIN:ID:%s";
    public static final String STUDENT_LOGIN_FAILURE = "SMS:STUDENT:LOGIN:FAILED:%s";
    public static final String USER_LOGIN_TOKEN = "SMS:USER:LOGIN:TOKEN:%s";

    public static String getStaffLoggedInKey(Integer id){ return String.format(STAFF_LOGIN_ID, id); }
    public static String getStaffLoginFailureCountKey(Integer id){
        return String.format(STAFF_LOGIN_FAILURE, id);
    }
    public static String getStudentLoggedInKey(Integer id){ return String.format(STUDENT_LOGIN_ID, id);}
    public static String getStudentLoginFailureCountKey(Integer id){return String.format(STUDENT_LOGIN_FAILURE, id);}
